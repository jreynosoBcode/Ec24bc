...
function GPS_enabled(position) {
    ...
    google.maps.event.addListener(map, 'click', function (event) {
     ...
     document.getElementById("txt_lat_des").value = lat;
     document.getElementById("txt_long_des").value = lng;
...
function custom_buttons() {
    ...
    backBtext.style.background = "#ffa500"
    backBtext.style.color = "#fff"
